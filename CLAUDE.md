...
This is the **Moonrise Watching Application** - an Android app to help users identify optimal nights for moonrise viewing by combining moon phase data, timing constraints, and weather forecasts.
...
- **Good night criteria:** Moon phase (2 days before to 5 days after full moon), moonrise before user's bedtime (default 11 PM), clear weather
